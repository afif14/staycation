                    ...
                    <div className="row" style={{marginTop: 80}}>
                        <div className="col-auto" style={{marginRight: 25}}>
                            ...
                            <h6 className="mt-3">
                                ...
                                <span className="text-gray-500 font-weight-light w-75"> travelers</span>
                            </h6>
                        </div>
                           <div className="col-auto" style={{marginRight: 25}}>
                            <img width="36" height="36" src={IconTreasures} alt={`${props.data.treasures} Treasure`}/>
                            <h6 className="mt-3">
                 ...
                 {/* kolom kanan */}
                    <div className="col-6 pl-5">
                        <div style={{width:520, height:410}}>
                            <img src={ImageHero} alt="Room with chouches" className="img-fluid position-absolute"
                                style={{margin: '-30px 0 0 -30px', zIndex:1}} />
                             <img src={ImageHero_} alt="Room with chouches frame" className="img-fluid position-absolute"
